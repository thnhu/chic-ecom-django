...
SECRET_KEY = 'django-insecure-tu&(rxz6!1mhqhgd)nrolc44j28_t8^a0a^)v1znn3i^c3ryto'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'coreui/static'),
                    os.path.join(BASE_DIR, 'products/static')] 

MEDIA_URL = '/media/'  # Nếu cần images dynamic sau
